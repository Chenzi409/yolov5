...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default= r"E:\yolov5-master\yolov5s.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default=r"E:\yolov5-master\models\yolov5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default= r"E:\yolov5-master\data\hangpai.yaml", help="dataset.yaml path")
