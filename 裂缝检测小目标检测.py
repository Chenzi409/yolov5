...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.setupUi(self)
        self.model = torch.hub.load("./", "custom", path="runs/train/exp10/weights/best.pt", source="local")
        self.timer = QTimer()
    ...
    def open_image(self):
        print("点击了检测图片！")
        file_path = QFileDialog.getOpenFileName(None, "Open Image", r"E:\yolov5-master\crack.v3-crack.yolov5pytorch\valid", filter="*.jpg;*.png;*.jpeg")
        if file_path[0]:
